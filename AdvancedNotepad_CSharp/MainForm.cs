...
//*****************************************************************************************************************************
        ...
        private void File_New_MenuItem_Click(object sender, EventArgs e)
        {
            ...
            this.Text = "Notepad_Kit [ Untitled "+count+" ]";
                ...
                if (tabpage != null)
                {
                    ...
                    if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if (filename != "")
                        {
                            ...
                            String fname = filename.Substring(filename.LastIndexOf("\\") + 1);
                            tabpage.Text = fname;
                            this.Text = "Notepad_Kit in C# [ " + fname + " ]";
                            FilenameToolStripLabel.Text = filename;
            ...
            if (myTabControlZ.TabCount > 0)
            {
                ...
                if (tabpage.Text.Contains("*"))
                {
                    ...
                    if (dg == DialogResult.Yes)
                    {
                        ...
                        if (myTabControlZ.TabCount == 0)
                        {
                            FilenameToolStripLabel.Text = "Notepad_Kit in C#";
                            count = 1;
                        }
                    }
                    else
                ...
                else
                {
                    ...
                    if (myTabControlZ.TabCount == 0)
                    {
                        FilenameToolStripLabel.Text = "Notepad_Kit C#";
                        count = 1;
                    }
                }
...
//*****************************************************************************************************************************
        ...
        private void myMenuStripZ_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {

        }

        private void myToolStripZ_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
